...
// Order matters: more specific entries are checked first. Keys are matched as
// substrings of the lowercased part name, so stems ("radiat") catch plurals and
// many spellings ("radiator", "radiators", "radiater").
const TABLE: Entry[] = [
  { key: "radiator", label: "Radiator", keys: ["radiator", "radiater", "radiat", "radiot", "intercooler", "thermostat"], Icon: Radiator },
  { key: "headlight", label: "Headlight", keys: ["headlight", "head light", "headlamp", "head lamp", "fog light", "fog lamp", "drl", "projector", "tail light", "taillight", "tail lamp", "reverse light", "xenon", "hid"], Icon: Headlight },
  { key: "bulb", label: "Light", keys: ["bulb", "led", "light", "lamp", "indicator", "turn signal", "blinker", "signal"], Icon: Bulb },
  { key: "battery", label: "Battery", keys: ["battery", "batt"], Icon: Battery },
  { key: "steering", label: "Steering", keys: ["steering", "steer", "tie rod", "rack and pinion", "rack", "drag link", "pitman", "idler arm"], Icon: Steering },
  { key: "pump", label: "Pump", keys: ["pump"], Icon: Pump },
  { key: "clutch", label: "Clutch", keys: ["clutch", "flywheel", "pressure plate", "release bearing"], Icon: Clutch },
  { key: "brake", label: "Brakes", keys: ["brake", "brak", "pad", "rotor", "disc", "disk", "caliper", "drum", "master cyl"], Icon: Brake },
  { key: "shock", label: "Suspension", keys: ["shock", "strut", "absorber", "suspension", "coil spring", "coilover", "spring", "damper", "control arm", "ball joint", "sway", "stabil", "leaf", "bushing", "lower arm", "upper arm"], Icon: Shock },
  { key: "tire", label: "Tire", keys: ["tyre", "tire", "wheel", "rim", "alloy", "hub", "bearing"], Icon: Tire },
  { key: "exhaust", label: "Exhaust", keys: ["exhaust", "muffler", "silencer", "catalytic", "downpipe", "down pipe", "resonator", "tailpipe", "tail pipe"], Icon: Exhaust },
  { key: "alternator", label: "Alternator", keys: ["alternator", "dynamo", "generator"], Icon: Alternator },
  { key: "starter", label: "Starter", keys: ["starter", "self start"], Icon: Starter },
  { key: "spark", label: "Spark Plug", keys: ["spark", "glow plug", "ignition", "coil pack", "distributor", "plug"], Icon: SparkPlug },
  { key: "mirror", label: "Mirror", keys: ["mirror", "rear view", "rearview"], Icon: Mirror },
  { key: "wiper", label: "Wiper", keys: ["wiper", "washer"], Icon: Wiper },
  { key: "filter", label: "Filter", keys: ["filter"], Icon: Filter },
  { key: "oil", label: "Fluid", keys: ["oil", "coolant", "antifreeze", "lubricant", "grease", "brake fluid", "fluid", "dexron", "atf"], Icon: Oil },
  { key: "belt", label: "Belt", keys: ["belt", "serpentine", "timing", "chain", "tensioner", "pulley", "idler"], Icon: Belt },
  { key: "fan", label: "Fan", keys: ["fan", "blower"], Icon: Fan },
  { key: "ac", label: "A/C", keys: ["a/c", "air con", "aircon", "air-con", "air condition", "compressor", "condenser", "evaporator", "expansion valve", "freon", "ac gas"], Icon: Ac },
  { key: "gears", label: "Transmission", keys: ["transmission", "gearbox", "gear box", "gear", "cvt", "torque converter", "differential", "diff", "axle", "cv joint", "cv axle", "driveshaft", "drive shaft", "propeller", "prop shaft"], Icon: Gears },
  { key: "sensor", label: "Sensor", keys: ["sensor", "o2", "oxygen", "maf", "map sensor", "crank sensor", "cam sensor", "speed sensor", "parking", "reverse sensor", "knock", "tps", "camera", "radar", "fuse", "relay", "wiring", "harness", "ecu", "ecm", "module", "computer", "circuit", "connector", "switch", "abs"], Icon: Sensor },
  { key: "windshield", label: "Glass", keys: ["windshield", "windscreen", "wind shield", "glass", "sunroof", "quarter glass", "window"], Icon: Windshield },
  { key: "door", label: "Door", keys: ["door", "handle", "lock", "latch", "hinge"], Icon: Door },
  { key: "bumper", label: "Bumper", keys: ["bumper"], Icon: Bumper },
  { key: "fender", label: "Body Panel", keys: ["fender", "wing", "quarter panel", "bonnet", "hood", "grille", "grill", "boot", "trunk", "tailgate", "spoiler", "mudguard", "mud guard", "apron", "panel", "body"], Icon: Fender },
  { key: "engine", label: "Engine", keys: ["engine", "motor", "cylinder", "piston", "crank", "crankshaft", "camshaft", "valve", "head gasket", "gasket", "turbo", "supercharger", "intake", "throttle", "injector", "carburet", "oil pan", "sump", "rocker", "tappet", "manifold", "fuel"], Icon: Engine },
];

// A diverse set used for the faint backdrop pattern in the product panel.
export const SHOWCASE_ICONS: { key: string; Icon: (p: IP) => JSX.Element }[] = [
  { key: "radiator", Icon: Radiator },
  { key: "brake", Icon: Brake },
  { key: "headlight", Icon: Headlight },
  { key: "battery", Icon: Battery },
  { key: "tire", Icon: Tire },
  { key: "alternator", Icon: Alternator },
  { key: "shock", Icon: Shock },
  { key: "exhaust", Icon: Exhaust },
  { key: "gears", Icon: Gears },
  { key: "belt", Icon: Belt },
  { key: "pump", Icon: Pump },
  { key: "sensor", Icon: Sensor },
  { key: "ac", Icon: Ac },
  { key: "mirror", Icon: Mirror },
  { key: "filter", Icon: Filter },
  { key: "spark", Icon: SparkPlug },
  { key: "wiper", Icon: Wiper },
  { key: "fan", Icon: Fan },
  { key: "steering", Icon: Steering },
  { key: "windshield", Icon: Windshield },
];
