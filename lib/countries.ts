// Worldwide country list with international dial codes for checkout.
// UAE (home market) is offered first; the rest are alphabetical.
export type Country = { name: string; dial: string };

export const COUNTRIES: Country[] = [
  { name: "United Arab Emirates", dial: "+971" },
  { name: "Afghanistan", dial: "+93" },
  { name: "Åland Islands", dial: "+358" },
  ...
  { name: "French Southern Territories", dial: "+262" },
  { name: "Gabon", dial: "+241" },
  ...
  { name: "Haiti", dial: "+509" },
  { name: "Heard & McDonald Islands", dial: "+672" },
  ...
  { name: "São Tomé & Príncipe", dial: "+239" },
  ...
  { name: "South Georgia & South Sandwich Islands", dial: "+500" },
  { name: "South Korea", dial: "+82" },
  { name: "South Sudan", dial: "+211" },
  { name: "Spain", dial: "+34" },
  { name: "Sri Lanka", dial: "+94" },
  { name: "St. Barthélemy", dial: "+590" },
  { name: "St. Helena", dial: "+290" },
  { name: "St. Kitts & Nevis", dial: "+1" },
  { name: "St. Lucia", dial: "+1" },
  { name: "St. Martin", dial: "+590" },
  { name: "St. Pierre & Miquelon", dial: "+508" },
  { name: "St. Vincent & Grenadines", dial: "+1" },
  { name: "Sudan", dial: "+249" },
  { name: "Suriname", dial: "+597" },
  { name: "Svalbard & Jan Mayen", dial: "+47" },
  { name: "Sweden", dial: "+46" },
  ...
  { name: "Wallis & Futuna", dial: "+681" },
  { name: "Western Sahara", dial: "+212" },
  { name: "Yemen", dial: "+967" },
