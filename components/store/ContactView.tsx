  ...
  return (
    <div className="sheet">
      ...
      <div style={{ marginTop: 26 }}>
        <div className="cline">
          <span className="c-ico" style={{ color: "#4da3ff" }} aria-hidden="true">
        ...
        <div className="cline">
          <span className="c-ico" style={{ color: "#ffc14d" }} aria-hidden="true">
            <svg viewBox="0 0 24 24" {...stroke}>
        ...
        <div className="cline">
          <span className="c-ico" style={{ color: "#ff6b6b" }} aria-hidden="true">
            <svg viewBox="0 0 24 24" {...stroke}>
        ...
        <div className="cline">
          <span className="c-ico" style={{ color: "#25d366" }} aria-hidden="true">
